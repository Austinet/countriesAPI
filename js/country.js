...
function displayCountry() {
    ...
    let currencies = lists(country.currencies)
    let languages = lists(country.languages)
    let borders = country.borders?.map(element => {
        // console.log(element)
        let borderName  = data.filter(country => country.alpha3Code == element)

        // console.log(data.map(element=>element.alpha3Code ))
        console.log(borderName)
        return (`<a class="btn" onclick="viewCountry('${borderName[0].name}')">${borderName[0].name}</a>`)
    }).join("")
    ...
    <div class="country-image">
        <img src="img/Belgium.JPG" alt="Belgian flag">
    ...
    <div class="country-details-container">
        ...
        <div class="country-details">
            <div>
                <p><span class="prop-name">Native Name:</span> <span class="prop-value">${country.nativeName}</span></p>
            ...
            <div>
                <p><span class="prop-name">Top Level Domain:</span> <span class="prop-value">${country.topLevelDomain}</span></p>
